...
@Entity
public class DriveGeotagHistory {
	...
	public DriveGeotagHistory(int Id,double feature_location_lat,double feature_location_lon,String modified_by,BigInteger drive_geotag_id,	BigInteger fr_job_execution_unit_id,BigInteger sign_id,	String value)
	{
		setId(Id);
